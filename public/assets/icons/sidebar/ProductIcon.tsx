...
const ProductIcon = () => {
  return (
    <svg className={`xl:w-6 xl:h-6 lg:w-[18px] lg:h-[18px] w-4 h-4 fill-current`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M12 15V2M12 2L15 5.5M12 2L9 5.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
  )
}
